...
function Data() {
  return (
    <div className="home__data">
        <h1 className="home__title">Deybi Orrego
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm web developer based in Bootcamp, and I'm very passionate and dedicated to my projects.</p>
